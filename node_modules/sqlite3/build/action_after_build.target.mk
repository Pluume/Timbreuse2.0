...
$(srcdir)/lib/binding/electron-v1.6-linux-x64/node_sqlite3.node: TOOLSET := $(TOOLSET)
$(srcdir)/lib/binding/electron-v1.6-linux-x64/node_sqlite3.node: $(builddir)/node_sqlite3.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(srcdir)/lib/binding/electron-v1.6-linux-x64/node_sqlite3.node
binding_gyp_action_after_build_target_copies = $(srcdir)/lib/binding/electron-v1.6-linux-x64/node_sqlite3.node
