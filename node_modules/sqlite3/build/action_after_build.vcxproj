...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{0F35C97A-7D95-59C5-52E1-631145FAD57C}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\User\.node-gyp\iojs-1.4.15\include\node;C:\Users\User\.node-gyp\iojs-1.4.15\src;C:\Users\User\.node-gyp\iojs-1.4.15\deps\uv\include;C:\Users\User\.node-gyp\iojs-1.4.15\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\User\.node-gyp\iojs-1.4.15\$(Configuration)\iojs.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;..\lib\binding\node-v48-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;..\lib\binding\node-v48-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to lib/binding/node-v48-win32-x64\node_sqlite3.node</Message>
      <Outputs>..\lib\binding\node-v48-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{F93B5EAB-F6EE-511C-E211-39741B5EBEEC}</Project>
