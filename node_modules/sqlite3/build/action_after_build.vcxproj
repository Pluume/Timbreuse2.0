...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{1301DB65-D10B-CAEB-7FE6-A66E6ACA3C9C}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\Francis-Lucien-Hugue\.node-gyp\6.10.0\include\node;C:\Users\Francis-Lucien-Hugue\.node-gyp\6.10.0\src;C:\Users\Francis-Lucien-Hugue\.node-gyp\6.10.0\deps\uv\include;C:\Users\Francis-Lucien-Hugue\.node-gyp\6.10.0\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\Francis-Lucien-Hugue\.node-gyp\6.10.0\$(Configuration)\node.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <ClCompile Include="P:\Timbreuse2.0\node_modules\node-gyp\src\win_delay_load_hook.cc"/>
  </ItemGroup>
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;P:\Timbreuse2.0\node_modules\sqlite3\lib\binding\node-v48-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;P:\Timbreuse2.0\node_modules\sqlite3\lib\binding\node-v48-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to P:/Timbreuse2.0/node_modules/sqlite3/lib/binding/node-v48-win32-x64\node_sqlite3.node</Message>
      <Outputs>P:\Timbreuse2.0\node_modules\sqlite3\lib\binding\node-v48-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{B70F77FD-9D2D-F65C-1AB4-9C1BD3E9EE12}</Project>
